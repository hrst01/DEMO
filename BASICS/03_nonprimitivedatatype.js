...
const found = array1.find((element) => element > 10);//10 se badi jo bhi sabse phle value milegi usko print krega
...
//     let c = a+b;
//     return c;
//     console.log(c); // This is an unreachable code
// }
// Return keyword will return anything from the function.
// But remember that anything you write after return will not be compiled
// console.log(Sum(5,4))
...
// Arrow function do not support "this"
